        ...
        case "/newProduct":
            ...
            break;
                case "/addProduct":
                    ...
                    break;
                case "/showProduct": {
                    List<Product> listProduct = productFacade.findExistingProduct();
                ...
                case "/addCustomer": {
                    ...
                    Customer customer = new Customer(nameCustomer, surname, new Integer(money));
                ...
                case "/showListPaid": {
                    ...
                    request.getRequestDispatcher(PageReturner.getPage("listPaid")).forward(request, response);
                    break;
                }
                case "/listPaid": {
                    ...
                    List<Purchase> buyProduct = purchaseFacade.findBuyProduct(product);
                ...
                case "/deleteProduct": {
                    ...
                    products.setActive(Boolean.FALSE);
